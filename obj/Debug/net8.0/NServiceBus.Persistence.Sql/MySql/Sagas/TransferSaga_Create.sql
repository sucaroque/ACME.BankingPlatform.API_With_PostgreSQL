...
set @query = IF(
    @exist <= 0,
    concat('alter table ', @tableNameQuoted, ' add column Correlation_TransactionId bigint(20)'), 'select \'Column Exists\' status');
...
set @query = IF(
    @column_type_TransactionId <> 'bigint(20)',
    'call sqlpersistence_raiseerror(concat(\'Incorrect data type for Correlation_TransactionId. Expected bigint(20) got \', @column_type_TransactionId, \'.\'));',
